            ...
            <div className="lg:flex gap-5 e-full lg:w-[90%] lg:mx-auto bg-white shadow-lg rounded-xl p-10 mb-10">
                ...
                <div className="w-full lg:w-[50%] h-full p-4">
                    ...
                    <p className='text-center h-full text-sm mt-5 lg:text-base text-gray-700 font-medium'>
                        I developed a teeth doctor website using the MERN stack, Firebase, and JWT for authentication. The website includes an admin dashboard and a user dashboard. Users can register, book appointments with doctors, view doctor details, and track their appointments. Admins have additional privileges, such as managing users and doctors. The website is mobile responsive and securely stores user data in MongoDB. It showcases my skills in front-end development, Firebase integration, JWT security, and mobile responsiveness.</p>
