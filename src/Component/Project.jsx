...
const Project = () => {
    return (
        <div id="project" className="p-5 bg-slate-100 lg:p-24">
            <h1 className='text-blue-500 font-semibold text-center text-2xl'>PORTFOLIO</h1>
            <p className='font-semibold lg:text-2xl mt-3 text-center mb-14'>Each project is a unique piece of development 🧩</p>

            <div className="lg:flex gap-5 e-full lg:w-[90%] lg:mx-auto bg-white shadow-xl rounded-xl p-10">
                <img className=' shadow-lg p-3 rounded-xl lg:w-[500px] ' src={Doctor} alt="" />
